...
import type { AgentStateSnapshot, DistillSkillResponse, ResumeOverrides, SkillDetail, SkillSummary } from '../types/api'
import type { RunPhase } from '../hooks/useConsole'
import { useNarrowViewport } from '../hooks/useNarrowViewport'
import { SKILL_ELIGIBILITY_HINT, threadEligibleForSkill } from '../lib/skillEligibility'
...
export function CommandColumn({
  ...
  const skillEligible = threadEligibleForSkill(accumulated, rounds)
  const canDistill =
        ...
        >
          ...
          <div className="skill-distill__body">
            <p className="command-column__hint">
              ...
              full harness loop, so you can confirm the workflow worked before
              saving.
            </p>
            {!skillEligible &&
              (phase === 'complete' || phase === 'awaiting_human') &&
