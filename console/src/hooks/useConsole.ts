...
export function useConsole() {
  ...
  const distillSkill = useCallback(async () => {
    ...
    if (!threadEligibleForSkill(accumulated, rounds)) {
      setError(SKILL_ELIGIBILITY_HINT)
      return
    }
  ...
  }, [accumulated, distillBusy, phase, runResponse?.rounds, skillName, threadId])
