...
From [`DESIGN.md`](DESIGN.md): command column · center spine/timeline ·
inspector stack. `StatusBar` spans the bottom.

```text
┌──────────────┬─────────────────────────┬──────────────┐
│ CommandColumn│ GraphSpine + TraceTimeline│ InspectorStack│
│  (240px)     │      (flex)             │   (320px)    │
├──────────────┴─────────────────────────┴──────────────┤
