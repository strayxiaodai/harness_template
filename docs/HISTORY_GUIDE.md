...
Use `docs/histories/` for finished code-change tasks. Pure Q&A, analysis, and
research tasks do not need a history entry unless they result in repository
changes.
...
- If a task spans multiple rounds, keep updating the same history file instead
...
- Template: [`docs/histories/template.md`](histories/template.md)
...
docs/histories/
  2026-07/
    20260707-0015-add-agents-docs-scaffold.md
```
